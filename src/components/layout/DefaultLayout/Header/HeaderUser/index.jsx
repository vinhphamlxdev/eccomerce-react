...
export default function HeaderUser() {
  return (
    <StyledHeaderUser className="p-2 bg-[#DBDBDB] header-account rounded-sm w-full flex flex-col gap-y-2 col-span-3">
      <span className="text-[#003B4F] text-sm ">Xin chào vinh pham</span>
      <div className="px-[0.7rem] cursor-pointer transition-all hover:opacity-80 py-[0.4rem] flex items-center gap-x-2 rounded-sm bg-[#EAEAEA]">
